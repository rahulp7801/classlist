            ...
            <div className="px-26 py-17.5 text-center">
              <Link className="mb-5.5 inline-block" href="/">
                ...
                <Image
                  ...
                  src={"/images/logo/vista-catalog-light.png"}
                  alt="Logo"
                  width={176}
                  height={32}
                />
              ...
              <p className="2xl:px-20">
                Explore Vista's course and club offerings with information regarding college admissions and four year planning.
              </p>

              <span className="mt-5 inline-block">
                <Image
                  src={"/images/product/login-homescreen.png"}
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Sign In to Vista Course Catalog
              </h2>
              ...
              <form>
                ...
                <div className="mt-6 text-center">
                  <p>
                    Don’t have any account?{" "}Click sign in with Google!
